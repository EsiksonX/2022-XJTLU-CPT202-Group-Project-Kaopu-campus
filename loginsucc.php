...
<head>
    ...
    <link href="css/me_dw1.css" rel="stylesheet" />
    <!-- 引入 layui.css -->
    ...
    <div class="home-div">
        <div class="home-div-top">
            <div class="home-div-top-l" id="head-div">
                <img src="<?php echo !empty($_SESSION['head']) ? $_SESSION['head'] : 'img/头像.png';?>" id="head-img">
            </div>
            <div  class="home-div-top-r">
                <h4><?php echo !($_SESSION['nickname']) ? $_SESSION['nickname'] : 'KaopuDefault';?></h4>
            </div>
        </div>
    </div>
</div>
