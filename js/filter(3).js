...
function StoreContainer(loop) {
	...
	for (var i = 0; i < loop; i++){
		let a ,rate = store_info[index].rate;
		if (a == null) {
			a = 0;
			rate = 'No Ratings Yet'
		}
		let rate_percent = a/5;
		content += `
					<section class="index-container shop-1">
						<div onclick="window.open('Store_detail.html','_self')" class="index-shopInfo">
							<div class="logo-container">
								<div class="logo-main">
									<img alt="${store_info[index].name}" class="logo-logo" src="http://kaopu-campus.online/KaopuUI/image/store/${store_info[index].id}/logo.jpg">
								</div>
							</div>
							<div class="index-main">
								<section class="index-line">
									<h3 class="index-shopname">
									<span style="font-size: 15px">${store_info[index].name}</span>
									</h3>
								</section>
								<section class="index-line">
								...
								<section class="index-line">
									<div class="index-moneylimit">
										<span style="font-size:12px;">¥${store_info[index].avg_price} per person</span>
									</div>
									<div class="index-distanceWrap">
										<span style="font-size:12px;">Distance: ${store_info[index].distance}</span>
									</div>
								</section>
							</div>
						</div>
						<div class="index-activityWrap">
							<section class="index-tagLine">
								...
								"${store_info[index].category}"
									<span class="index-tagGhost mini-tag-ghost" style="color: rgb(102, 102, 102); border-color: rgb(221, 221, 221); font-size:10px;">${store_info[index].category}</span>
								</span>
							</section>
						</div>
					</section>`;
